...
from base_model.qwenvlchat.configuration_qwen import QWenConfig
...
#    model_type = "llaga"
class LlagaConfig(AutoConfig):
    model_type = "qwen"

#class LlagaLlamaModel(LlagaMetaModel, LlamaModel):
class LlagaLlamaModel(LlagaMetaModel, AutoModel):
...
class LlagaLlamaForCausalLM(AutoModelForCausalLM, LlagaMetaForCausalLM):
    config_class = QWenConfig
...
AutoConfig.register("qwen", QWenConfig) # LlagaConfig
AutoModelForCausalLM.register(QWenConfig, LlagaLlamaForCausalLM)
